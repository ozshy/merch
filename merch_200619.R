...
#
setwd("~/Papers/merch/merch_coding")# Set working directory on your computer
...
length(unique(m4[!is.na(m4$in_person), ]$uasid))
...
length(unique(m6$uasid))# num respondents
...
nrow(m8)# num trans
length(unique(m8$uasid))# num resp
